...
TrainDatabasePath="C:\Users\Mayur\Desktop\projects\Face_recognition-master\train database";
% prompt=('Enter test image directory');
% dlg_title='Input for directory';
% num_lines= 1;
% def = {'Drive:\\directory_location'};

% TestDatabasePath = inputdlg(prompt,dlg_title,num_lines,def);
TestDatabasePath ="C:\Users\Mayur\Desktop\projects\Face_recognition-master\test database";
